...
const ThdOffsets thd_offsets_arr[] =
{
	...
	{"5.6.33","e2212f9be5f7e63f938bc47dd5de2fec", 6992, 7040, 4000, 4520, 72, 2704, 96, 0, 32, 104, 136, 7128},
	//offsets for: /mysqlrpm/5.7.15/usr/sbin/mysqld (5.7.15)
	{"5.7.15","ef1b79e2b9be6311a1a5f833a8104576", 7800, 7848, 3624, 4776, 456, 360, 0, 32, 64, 160, 536, 7964},
	//offsets for: /mysqlrpm/5.5.51/usr/sbin/mysqld (5.5.51)
	{"5.5.51","5868e9151efc03f4770d39c9f940356c", 6144, 6192, 3816, 4312, 88, 2592, 96, 0, 32, 104, 120, 6264},
	//offsets for: /mysqlrpm/5.7.14/usr/sbin/mysqld (5.7.14)
	{"5.7.14","b41e26b4bef917075a2c6d0f64327f74", 7800, 7848, 3624, 4776, 456, 360, 0, 32, 64, 160, 536, 7964},
...
const ThdOffsets thd_offsets_arr[] =
{
	...
	//offsets for: /mysqlrpm/5.6.33/usr/sbin/mysqld (5.6.33)
	{"5.6.33","3d336ff8886f2243e5ba17e2b8f1900a", 4676, 4704, 2660, 3052, 36, 1748, 60, 0, 20, 64, 72, 4776},
	//offsets for: /mysqlrpm/5.7.15/usr/sbin/mysqld (5.7.15)
	{"5.7.15","c095c56d9a6943b56579eeaa8865213f", 5072, 5100, 2208, 3028, 296, 200, 0, 20, 40, 100, 340, 5188},
	//offsets for: /mysqlrpm/5.5.51/usr/sbin/mysqld (5.5.51)
	{"5.5.51","f94f10989d22e1f628de8fe475f6365f", 3872, 3900, 2368, 2748, 44, 1656, 60, 0, 20, 64, 60, 3956},
	//offsets for: /mysqlrpm/5.7.14/usr/sbin/mysqld (5.7.14)
	{"5.7.14","377547cf69fcc65b918a214233e212b2", 5072, 5100, 2208, 3028, 296, 200, 0, 20, 40, 100, 340, 5188},
	//offsets for: /mysqlrpm/5.6.32/usr/sbin/mysqld (5.6.32)
...
const ThdOffsets thd_offsets_arr[] =
{
	...
	//offsets for: /mariadb/10.1.19/bin/mysqld (10.1.19-MariaDB)
	{"10.1.19-MariaDB","ef2a3687980975905aad00f127d8c623", 13640, 13704, 6416, 8024, 88, 2976, 8, 0, 16, 24, 152, 13796},
	//offsets for: /mariadb/10.0.28/bin/mysqld (10.0.28-MariaDB)
	{"10.0.28-MariaDB","0e06a7e3a9f98b9d5225b7eddacd3d3d", 13480, 13544, 6256, 7864, 88, 2976, 8, 0, 16, 24, 152, 13636},
	...
	{"10.0.27-MariaDB","0fe5dce5b7c939b6c3de226b4a49ef9b", 13480, 13544, 6256, 7864, 88, 2976, 8, 0, 16, 24, 152, 13636},
	//offsets for: /mariadb/5.5.51/bin/mysqld (5.5.51-MariaDB)
	{"5.5.51-MariaDB","e921664656995c5bbbf4b1926c6448c5", 12032, 12096, 5800, 6904, 88, 2920, 8, 0, 16, 24, 152, 12168},
	//offsets for: /mariadb/10.1.16/bin/mysqld (10.1.16-MariaDB)
	{"10.1.16-MariaDB","b89b6660fa1b5d1e7e55ca5cd7f6efe9", 13592, 13656, 6368, 7976, 88, 2976, 8, 0, 16, 24, 152, 13748},
...
const ThdOffsets thd_offsets_arr[] =
{
	...
	//offsets for: /mariadb/10.1.19/bin/mysqld (10.1.19-MariaDB)
	{"10.1.19-MariaDB","3a307bdeb871d13329cb858deb70c387", 8496, 8532, 3840, 5300, 44, 1892, 4, 0, 8, 12, 84, 8608},
	//offsets for: /mariadb/10.0.28/bin/mysqld (10.0.28-MariaDB)
	{"10.0.28-MariaDB","7b2b43549c43b7a711567ad6694ac2d5", 8368, 8404, 3712, 5172, 44, 1892, 4, 0, 8, 12, 84, 8476},
	//offsets for: /mariadb/5.5.53/bin/mysqld (5.5.53-MariaDB)
	...
	//offsets for: /mariadb/10.0.27/bin/mysqld (10.0.27-MariaDB)
	{"10.0.27-MariaDB","ae20d24d041ac5e04696ff43dce88266", 8368, 8404, 3712, 5172, 44, 1892, 4, 0, 8, 12, 84, 8476},
	//offsets for: /mariadb/5.5.51/bin/mysqld (5.5.51-MariaDB)
	{"5.5.51-MariaDB","d59f47cae642748db4fbb5fb16d658dc", 7276, 7312, 3460, 4468, 44, 1856, 4, 0, 8, 12, 84, 7372},
	//offsets for: /mariadb/10.1.16/bin/mysqld (10.1.16-MariaDB)
	{"10.1.16-MariaDB","036ee9ad39def227525fa93fe82d6bc0", 8472, 8508, 3816, 5276, 44, 1892, 4, 0, 8, 12, 84, 8584},
	//offsets for: /mariadb/10.1.15/bin/mysqld (10.1.15-MariaDB)
